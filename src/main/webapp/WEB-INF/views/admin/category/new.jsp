	...
	<div class="modal-body">
		<form id="newForm">
			<div class="form-group">
				<label>Нэр</label> <input type="text" name="ner"
					class="form-control" placeholder="Нэр...">
			</div>

			<div class="form-group">
				<label>Тайлбар</label> <input type="text" name="tailbar"
					class="form-control" placeholder="Тайлбар...">
			</div>
